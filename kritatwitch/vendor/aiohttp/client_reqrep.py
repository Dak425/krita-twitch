...
import attr
from kritatwitch.vendor.multidict import CIMultiDict, CIMultiDictProxy, MultiDict, MultiDictProxy
...
try:
    ...
    from kritatwitch.vendor import charset_normalizer as chardet  # type: ignore[no-redef]
